...
let(:my_question) {Question.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false) }
 ...
 describe "GET new" do
  ...
  describe "QUESTION create" do
    it "increases the number of the Question by 1" do
    ...
    it "assigns the new question to @question" do
      expect{post :create, post: {title: RandomData.random_sentence, body: random_paragraph}}
      expect(assigns(:question)).to eq Question.last
    end

    it "redirects to the new question" do
      post :create, question: {title: RandomData.random_sentence, body: random_paragraph}
